...
public:
  ...
  int Card() const {return size;}; // The effective number of element in the set
  ...
  bool Equal(Set& a, Set& b); //verify the equality of two sets
  int* Intersect(Set& a,Set& b); //compute the intersection of two sets
  int* Union(Set& a,Set& b); //compute the union of two sets
